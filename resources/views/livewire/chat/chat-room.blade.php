        ...
        <div class="chat-not-selected h-100 ">
            <div class="d-flex align-items-center justify-content-center h-100 p-5">
                <div class="text-center">
                    ...
                    <h6 class="mt-2">Selecione uma coversa apartir da lista</h6>
                </div>
            </div>
        </div>
        <div class="chatting-box d-block">
            ...
            <div class="d-flex parent-chat-box app-chat-right">
                <div class="chat-box w-xs-100">
                    <div class="chat-box-inner p-9" id="chat-box"
                        style="scrollbar-width:thin; max-height: 65%; overflow: scroll; overflow-x: hidden;">
                        <div class="chat-list chat active-chat" data-user-id="1">
                            <div class="form-group" style="text-align: center;">Ontem</div> <br>
                            ...
                            <div class="hstack gap-3 align-items-start mb-7 justify-content-start">
                                ...
                                <div>
                                    ...
                                    <div class="rounded-2 overflow-hidden">
                                        <img src="/assets/images/products/product-1.jpg" alt="matdash-img"
                                            class="w-100" />
                                    </div>
                                </div>
                            </div>
